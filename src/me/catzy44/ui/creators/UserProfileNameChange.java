...
public class UserProfileNameChange {
	private JFrame frame;
	private PlaceholderTextField login;
	private UserProfile up;
	
	public UserProfileNameChange(UserProfile up) {
		this.up = up;
	}
	...
	private void build() {
		try {
			...
			JLabel lblEndimcLauncher = new JLabel("Endi Launcher - Zmiana nazwy profilu");
			...
			JLabel lblLogowanieDoKonta = new JLabel("Wprowadź nową nazwę", SwingConstants.CENTER);
			...
			JButton nonpresmium = new JButton("Zmień");
			...
			login.setText(up.getProfileName());
