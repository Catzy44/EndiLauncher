...
public class CustomComboBoxRendererBig extends JLabel implements ListCellRenderer<Object> {
	private static final long serialVersionUID = -1363514186588801222L;

	public CustomComboBoxRendererBig() {
        setOpaque(true);
        setFont(Interface.ralewayMedium.deriveFont(15f));
