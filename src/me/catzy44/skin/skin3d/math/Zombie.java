package me.catzy44.skin.skin3d.math;
...
import me.catzy44.math.VanillaMath;
import me.catzy44.skin.skin3d.ImageHelper;
import me.catzy44.skin.skin3d.ModelPreview;
import me.catzy44.skin.skin3d.gfx.Bitmap;
import me.catzy44.skin.skin3d.gfx.Bitmap3d;
...
public class Zombie {
    ...
    /** Default skin path. */
    public String defaultSkin = "/files/images/default_skin.png";
    ...
    public void render(Matrix3 m, Bitmap3d bitmap, double time) {
        ...
        case 1: {
            ...
            iArm0Clothes.xRot = arm0Clothes.xRot = arm0.xRot = VanillaMath.sin(time * 0.067) * 0.05;
            iArm0Clothes.zRot = arm0Clothes.zRot = arm0.zRot = VanillaMath.cos(time * 0.09) * 0.05 + 0.05;
            ...
            iArm2Clothes.xRot = arm2Clothes.xRot = arm2.xRot = arm1.xRot = VanillaMath.sin(time * 0.067) * 0.05;
            iArm2Clothes.zRot = arm2Clothes.zRot = arm2.zRot = arm1.zRot = VanillaMath.cos(time * 0.09) * -0.05 + -0.05;
        ...
        default: {
            // Running
            y = (-Math.abs(VanillaMath.sin(time * 0.6662))) * 5.0 - 24.0 + 20.0;

            iHair.yRot = hair.yRot = head.yRot = VanillaMath.sin(time * 0.23) * 0.4;//from 1.0
            iHair.xRot = hair.xRot = head.xRot = VanillaMath.sin(time * 0.1) * 0.4;//from 0.8

            iArm0Clothes.xRot = arm0Clothes.xRot = arm0.xRot = VanillaMath.sin(time * 0.6662 + 3.141592653589793) * 2.0;
            iArm0Clothes.zRot = arm0Clothes.zRot = arm0.zRot = (VanillaMath.sin(time * 0.2312) + 1.0) * 0.5;//from 1.0

            iSlimArm0Clothes.xRot = slimArm0Clothes.xRot = slimArm0.xRot = arm0.xRot;
            iSlimArm0Clothes.zRot = slimArm0Clothes.zRot = slimArm0.zRot = arm0.zRot;

            iArm2Clothes.xRot = arm2Clothes.xRot = arm2.xRot = arm1.xRot = VanillaMath.sin(time * 0.6662) * 2.0;
            iArm2Clothes.zRot = arm2Clothes.zRot = arm2.zRot = arm1.zRot = (VanillaMath.sin(time * 0.2812) - 1.0) * 0.5;//from 1.0

            iSlimArm2Clothes.xRot = slimArm2Clothes.xRot = slimArm2.xRot = arm1.xRot;
            iSlimArm2Clothes.zRot = slimArm2Clothes.zRot = slimArm2.zRot = arm1.zRot;

            iLeg0Clothes.xRot = leg0Clothes.xRot = leg0.xRot = VanillaMath.sin(time * 0.6662) * 1.0;//from 1.4
            iLeg0Clothes.yRot = leg0Clothes.yRot = leg0.yRot = 0;

            iLeg2Clothes.xRot = leg2Clothes.xRot = leg2.xRot = leg1.xRot = VanillaMath.sin(time * 0.6662 + 3.141592653589793) * 1.0;//from 1.4
            iLeg2Clothes.yRot = leg2Clothes.yRot = leg2.yRot = leg1.yRot = 0;
